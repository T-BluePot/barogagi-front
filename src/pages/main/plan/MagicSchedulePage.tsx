      ...
      <div className="mt-auto w-full p-6">
        ...
        >
          <motion.span
            ...
            //
            // 한 번 털기 = [0 → -18 → 16 → -12 → 0]. 그걸 짧은 사이를 두고 두 번 반복한 뒤
            // repeatDelay 로 길게 쉰다. times 로 각 구간을 잡아야 두 번째 털기가
            // 첫 번째와 같은 속도로 나온다(균등 분배에 맡기면 뒤로 갈수록 느려진다).
            //
            // ease 는 linear 다. "easeInOut" 이면 키프레임마다 속도가 0이 되어 좌우 끝에서
            // 멈칫하고, 그러면 한 번 털기가 "휙 / 멈춤 / 휙" 두 동작으로 쪼개져 보인다.
            animate={{ rotate: [0, -18, 16, -12, 0, 0, -18, 16, -12, 0] }}
            transition={{
              duration: 0.72,
              times: [0, 0.09, 0.18, 0.27, 0.36, 0.5, 0.59, 0.68, 0.77, 1],
              repeat: Infinity,
              repeatDelay: 1.2,
              ease: "linear",
            }}
