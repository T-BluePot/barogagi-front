      ...
      <div className="mt-auto w-full p-6">
        ...
        >
          <motion.span
            ...
            // 봉을 손에 쥐고 두 번 휙휙 젓는 느낌 — 장식이라 접근성 트리에서는 감춘다.
            //
            // 좌-우-좌-우로 네 번 긋고 마지막에만 제자리로 돌아온다.
            // 중간에 0(제자리)을 넣지 않는 게 핵심이다. 첫 번째 젓기를 제자리까지
            // 되돌려놓고 다시 시작하면, 한 동작이 아니라 별개의 두 동작으로 끊겨 보인다.
            //
