...
const Button = ({ label, onClick, icon, isDisabled = false }: ButtonProps) => {
  const baseStyle = `px-4 py-3 rounded-full w-full flex items-center justify-center typo-body focus:outline-none cursor-pointer transition-colors duration-200 ${
    isDisabled
