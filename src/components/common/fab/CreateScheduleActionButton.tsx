  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-[max(24px,calc(50vw-var(--app-max-width)/2+24px))] bottom-[calc(var(--fab-bottom)+max(env(safe-area-inset-bottom,0px),var(--sai-bottom,0px)))] z-50 flex h-[var(--fab-size)] w-[var(--fab-size)] items-center justify-center rounded-full bg-peach text-white shadow-fab transition-colors duration-120 ease-fitpl active:bg-peach-active"
      >
        <motion.svg
          width={24}
          height={24}
