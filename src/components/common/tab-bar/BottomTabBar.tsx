...
const BottomTabBar = () => {
  ...
  return (
    <nav
      aria-label="Tabs"
      className="fixed inset-x-0 mx-auto w-[calc(100%-32px)] max-w-[calc(var(--app-max-width)-32px)] bottom-[calc(var(--tabbar-bottom)+max(env(safe-area-inset-bottom,0px),var(--sai-bottom,0px)))] z-30 h-[var(--tabbar-height)] rounded-full bg-white/75 px-2 backdrop-blur-[20px] backdrop-saturate-[1.8] shadow-tabbar"
    >
