 ...
 *
 * 티켓·침대는 자체 작도본이 34px 에서 형태를 알아볼 수 없어 **Lucide 도형으로 대체**했다
 * (`.claude/design/DESIGN.md` §8: 없는 아이콘은 Lucide 로 대체하고 대체 사실을 명시).
 */
const CATEGORY_ICON_PATH: Record<string, string> = {
  // 문화관광 — 공연/전시 (티켓, Lucide ticket)
  문화관광:
    "M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z M13 5v14",
  // 역사관광 — 전통 건축 (기와 지붕)
  역사관광: "M3 9h18L12 4 3 9Zm2 0v11m14-11v11M3 20h18M9 20v-6h6v6",
  // 쇼핑 — 쇼핑백
  쇼핑: "M6 8h12l-1 12H7L6 8Zm3 0V6a3 3 0 0 1 6 0v2",
  // 숙박 — 침대 (Lucide bed)
  숙박: "M4 17v-6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v6 M4 17h16 M4 20v-3 M20 20v-3 M8 9V6h4v3",
  // 기타관광 — 지도 핀
  기타관광:
    "M12 21s7-5.4 7-11a7 7 0 1 0-14 0c0 5.6 7 11 7 11Zm0-8.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z",
};
