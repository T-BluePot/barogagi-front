  ...
  <div className="flex justify-end gap-1.5">
    {QUICK_MINUTES.map((minute) => (
      <button
        ...
        className="typo-tag flex h-8 w-8 items-center justify-center rounded-full bg-gray-white text-gray-70 shadow-[0_2px_6px_rgba(15,23,42,0.08)] transition-all duration-150 ease-fitpl cursor-pointer active:scale-95 active:shadow-[0_1px_3px_rgba(15,23,42,0.06)]"
      >
        {minute}
      </button>
    ))}
